...
public class UIForBiQuGe {
    ...
    public static void buildSearchUI() {
        JFrame frame = new JFrame("从笔趣阁搜索小说/作者");
        ...
        button.addActionListener(e -> {
            ...
            List<Title> titles = SearchFromBiQuGe.searchNovel(searchName);
            ...
            for (int i = 0; i< titles.size(); i++) {
                ...
                titleButton.addActionListener(e1 -> buildDownLoadUI(title.getTitleName(), title.getUri()));
                frame.repaint();
            }
        });
    ...
    public static void fetchNovel(String titleName, String uri) {
        boolean result = FetchFromBiQuGe.fetchNovel(titleName, uri);
    ...
    public static void buildDownLoadUI(String titleName, String uri) {
        JFrame.setDefaultLookAndFeelDecorated(false);
        JFrame frame = new JFrame("从笔趣阁下载小说");
        //宽和高
